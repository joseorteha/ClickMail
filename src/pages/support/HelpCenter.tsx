...
const HelpCenter = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-2xl mx-auto mb-10">
        <form onSubmit={handleSearch} className="flex">
          <input
            ...
            className="w-full px-4 py-3 rounded-l-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <button 
            type="submit"
      ...
      {/* Contacto adicional */}
      <div className="mt-12 bg-gray-50 dark:bg-gray-900 rounded-xl p-6 max-w-3xl mx-auto">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <a 
            ...
            className="inline-flex items-center bg-white dark:bg-gray-800 text-gray-700 dark:text-white border border-gray-300 dark:border-gray-700 px-5 py-2.5 rounded-lg font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition shadow-sm"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">

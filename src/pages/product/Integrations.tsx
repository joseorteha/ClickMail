    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 my-10">
        {integrations.map((integration, index) => (
          <div key={index} className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow overflow-hidden">
            <div className="p-6">
              ...
              <div className="flex items-center mb-3">
                {/* Placeholder para el icono - en producción se usaría la imagen real */}
      ...
      <h2>¿No encuentras la integración que necesitas?</h2>
      <p>

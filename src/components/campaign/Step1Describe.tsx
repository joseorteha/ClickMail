  ...
  return (
    <div className="max-w-3xl mx-auto w-full py-6 sm:py-8">
      ...
      <div className="mb-6 sm:mb-10 text-center sm:text-left">
        ...
        <p className="text-gray-600 dark:text-gray-300">Ingresa un nombre y descripción de tu producto, servicio u oferta</p>
      </div>
      
      {/* Campo para el nombre de la campaña */}
      <div className="mb-4">
        <label htmlFor="campaign-name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nombre de la campaña *</label>
        <input
          id="campaign-name"
          type="text"
          ...
          placeholder="Ej: Promoción verano 2025, Lanzamiento nuevo producto, etc."
          value={value.name || ''}
          onChange={e => onChange({ ...value, name: e.target.value })}
          maxLength={100}
          required
        />
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 text-right">{value.name?.length || 0}/100</p>
      </div>
